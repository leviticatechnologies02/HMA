            ...
            <>
              ...
              {role === "visitor" && (
                <>
                  <Link
                    to="/profile"
                    className="px-4 py-2 text-sm font-medium text-dark hover:text-primary transition-colors dark:text-[#E2E8F0] dark:hover:text-primary"
                  >
                    My Profile
                  </Link>
          ...
          <div className="fixed top-20 left-0 right-0 bottom-0 z-[99] md:hidden bg-white dark:bg-[#0D0D1A] border-t border-gray-200 dark:border-white/10 animate-slide-up flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-5 py-5">
              ...
              <MobileNavLink
                ...
                label="Rent Calculator"
                icon={
                  <span className="w-4 h-4 text-center text-xs font-bold">
                    ₹
                  </span>
                }
              />
              ...
              <button
                onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
                className="w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-dark hover:bg-slate-100 hover:text-primary rounded-xl transition-colors dark:text-[#E2E8F0] dark:hover:bg-white/5 dark:hover:text-primary"
              ...
              {userId && (
                <>
                  ...
                  <button
                    onClick={() => logoutMutation.mutate()}
                    className="w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-error hover:bg-error/5 rounded-xl transition-colors dark:hover:bg-error/10"
                  >
                    <LogOut className="w-4 h-4" />
                    Logout
                  </button>
            ...
            {/* Bottom Buttons */}
            {!userId && (
              <div className="border-t border-gray-200 dark:border-white/10 bg-white dark:bg-[#0D0D1A] p-5 space-y-3">
                <Link
                  to="/login"
                ...
                <Link
                  to="/register-hostel"
                  className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-primary bg-primary/10 hover:bg-primary/20 transition-colors dark:bg-primary/20 dark:hover:bg-primary/30"
                >
                  <Building2 className="w-4 h-4" />
                  Register Hostel
                </Link>
...
function MobileNavLink({
  ...
  return (
    <Link
      to={to}
      className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-dark hover:bg-primary/5 hover:text-primary transition-colors dark:text-[#E2E8F0] dark:hover:bg-primary/10 dark:hover:text-primary"
    >
      {icon}
      {label}
    </Link>
