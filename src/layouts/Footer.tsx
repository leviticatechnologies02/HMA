    ...
    <footer className="bg-dark text-slate-400  mb-16 md:mb-0">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            ...
            <p className="text-sm leading-relaxed">
              India's trusted hostel booking platform. Day-wise and monthly
              bookings with bed-level control.
            </p>
            ...
            <div className="mt-5 space-y-3 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <a
                  href="mailto:info@leviticaconnect.com"
                  className="hover:text-white transition-colors break-all"
                >
                  info@leviticaconnect.com
                </a>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="leading-6">
                  5th Floor, C9WP+P68 Techno Park, S2,
                  <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              <p className="text-white font-semibold text-base mb-1">
                Get the Leviticanestora by Levitica Technologies
              </p>
              <p className="text-slate-400 text-sm">
                Book hostels on the go — available on Android & iOS
              </p>
            </div>
            <div className="flex items-center gap-3 flex-wrap">
              ...
              >
                ...
                >
                  <path
                    d="M3.18 1.07C2.76 1.5 2.5 2.17 2.5 3.04v17.92c0 .87.26 1.54.68 1.97l.1.09 10.04-10.04v-.24L3.28.98l-.1.09z"
                    fill="#EA4335"
                  />
                  <path
                    d="M16.67 16.32l-3.35-3.35v-.24l3.35-3.35.08.04 3.97 2.26c1.13.64 1.13 1.69 0 2.34l-3.97 2.26-.08.04z"
                    fill="#FBBC04"
                  />
                  <path
                    d="M16.75 16.28L13.32 12.84 3.18 22.97c.37.4.98.44 1.67.05l11.9-6.74"
                    fill="#34A853"
                  />
                  <path
                    d="M16.75 7.72L4.85 1c-.69-.4-1.3-.36-1.67.05L13.32 11.16l3.43-3.44z"
                    fill="#4285F4"
                  />
                </svg>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm">
            &copy; 2026 Leviticanestora. All rights reserved.
          </p>
