  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 text-xs font-medium text-dark dark:text-slate-200 hover:border-primary/40 transition-all"
      >
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute top-full left-0 mt-1 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl z-50 min-w-48 overflow-hidden">
