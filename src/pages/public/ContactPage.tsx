...
export default function Contact() {
  ...
  const faqItems = [
    {
      id: 1,
      question: "What is HostelMS?",
      answer:
        "HostelMS is a comprehensive hostel management system designed to streamline operations, manage bookings, automate billing, track maintenance, and improve communication between staff and residents.",
    },
    {
      id: 2,
      question: "How can HostelMS help my hostel?",
      answer:
        "Our platform helps reduce administrative overhead, minimize errors, improve resident satisfaction, and provide real-time insights into your hostel operations with an intuitive dashboard.",
    },
    {
      id: 3,
      question: "Is there a free trial available?",
      answer:
        "Yes! We offer a 14-day free trial for all new customers. No credit card required. Experience all features with your complete hostel data.",
    },
    {
      id: 4,
      question: "What support do you provide?",
      answer:
        "We provide 24/7 customer support via email, phone, and live chat. Our team is always ready to help with any questions or issues you might encounter.",
    },
    {
      id: 5,
      question: "Can I integrate HostelMS with my existing systems?",
      answer:
        "Absolutely! HostelMS integrates seamlessly with popular accounting software, payment gateways, and communication platforms to enhance your workflow.",
    },
    {
      id: 6,
      question: "What about data security and privacy?",
      answer:
        "We prioritize your data security with enterprise-grade encryption, regular backups, GDPR compliance, and strict access controls to protect your sensitive information.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#06292d] ">
      <section className="relative overflow-hidden bg-[#07363A]">
        {/* Dark Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#06292d]/95 via-[#07383c]/85 to-[#0a4044]/45"></div>
        ...
        <div className="relative z-20 mx-auto flex flex-col-reverse lg:flex-row min-h-screen max-w-[1600px]">
          ...
          <div className="w-full lg:w-1/2 px-6 sm:px-8 md:px-10 lg:px-14 pt-10 lg:pt-8 pb-12 lg:pb-16 text-center lg:text-left">
            ...
            <h1 className="mt-8 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight lg:leading-none text-white">
              Contact{" "}
              <span className="bg-gradient-to-r from-[#72e0b6] to-[#49c89d] bg-clip-text text-transparent">
                HostelMS
              </span>
            </h1>
            ...
            <p className="mt-6 lg:mt-8 max-w-xl mx-auto lg:mx-0 text-base sm:text-lg lg:text-xl leading-7 lg:leading-9 text-slate-200">
              Reach out for bookings, onboarding help, product support, or a
              personalized walkthrough of how HostelMS can simplify your
              property management.
            </p>
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="group rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-none transition-all duration-300 hover:-translate-y-2 hover:border-emerald-300/40 hover:bg-white/10 hover:shadow-[0_20px_40px_rgba(16,185,129,.15)]">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-emerald-400/20 transition-all duration-300 group-hover:scale-110 group-hover:bg-emerald-400/30">
                  <MessageCircle className="h-6 w-6 text-emerald-300" />
                </div>

                <h3 className="font-bold text-white">Fast replies</h3>
              ...
              <div className="group rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-none transition-all duration-300 hover:-translate-y-2 hover:border-emerald-300/40 hover:bg-white/10 hover:shadow-[0_20px_40px_rgba(16,185,129,.15)]">
                ...
                <h3 className="font-bold text-white">Free consult</h3>
            ...
            <div className="relative z-50 mt-10 lg:mt-14 flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <a
                href="#contact-form"
                className="relative z-50 flex items-center gap-3 rounded-2xl bg-gradient-to-r from-[#71E1B7] to-[#45C89B] px-8 py-4 font-semibold text-[#06343A] shadow-lg transition-all duration-300 hover:scale-105"
              >
                <Send className="h-5 w-5" />
                Contact Us
              </a>
              ...
              <Link to="/register">
                <button className="relative z-50 w-full sm:w-auto rounded-2xl border border-white px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base font-semibold text-white transition-all duration-300 hover:bg-white/10 hover:scale-105">
                  Request Demo
                </button>
              </Link>
            </div>
          ...
          <div className="relative w-full lg:w-1/2 h-[420px] sm:h-[520px] lg:min-h-[760px] flex items-center justify-center">
            {/* Background Photo */}
            <div className="absolute inset-0 overflow-hidden rounded-r-[34px] -z-10">
              <img
                src="/img/Touch1.png"
  ...
  "
              ...
              <div className="absolute inset-0 bg-gradient-to-l from-transparent via-[#06292d]/40 to-[#06292d]" />
            </div>
